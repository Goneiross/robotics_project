...
/**
* @brief Structure d̩finissant les diff̩rents move
*/
typedef enum {
	ESCAPE_OBSTACLE,
    MOVE_FORWARD,
...
/**
* @brief Structure d̩finissant les modes de gestion des LEDS
*/
typedef enum {
	FOLLOW_PITCH,
    MANUAL,
...
/**
* @brief Structure d̩finissant une couleur en RGB
*/
typedef struct rgb
{
    uint8_t r;
